...
export default function ProductDetail() {
  ...
  const confirmRent = () => {
    ...
    const totalPrice = daysDiff * equipment.dailyRate;

    Modal.confirm({
      title: "Xác nhận thuê thiết bị",
      content: (
        <div>
          <p>Bạn có chắc chắn muốn thuê thiết bị này không?</p>
          <p>
            <strong>Số ngày thuê:</strong> {daysDiff} ngày
          </p>
          <p>
            <strong>Tổng tiền thuê:</strong> {totalPrice.toLocaleString()} VND
          </p>
        </div>
      ),
      okText: "Xác nhận",
  ...
  return (
    <div className="bg-white flex flex-col items-center py-10 px-4">
      ...
      <p className="text-lg mb-4">
        Giá thuê: {equipment.dailyRate.toLocaleString()} VND/Ngày
      </p>
